Smits = {};Smits.Common = {
	...
	return function(inputFormat, sDivId, canvasWidth, canvasHeight, type){
		...
		if(typeof inputFormat === "object"){
			...
			// Phylowood: Nexus BEAST input
			else if(inputFormat.nexusBeast){
				dataObject = new Smits.PhyloCanvas.NexusBeastParse(inputFormat);			
			} else {
...
Smits.PhyloCanvas.NexusBeastParse = function(){
